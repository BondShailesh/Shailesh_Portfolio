...
import { Send, Phone, MapPin, Mail, SmartphoneNfc } from "lucide-react";
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Shaileshka17@gmail.com</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="bg-purple-500/10 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">9472363585</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Kolkata 700101</p>
                  </div>
                </div>
              </div>
            </div>
