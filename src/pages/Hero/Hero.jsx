...
const profile = {
    ...
    skills: [
        'Java Script', 'React', 'NextJS', 'Redux', 'Express',
        'MySQL', 'MongoDB', 'Docker', 'AWS', 'TypeScript',
        'Git', 'Linux', 'Pyhton', 'Flask', 'Django'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  MERN Stack Developer | DevOps Enthusiast | Python & AI Integration in Progress 🤖🚀  
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/BondShailesh"
                  target="_blank"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1ULxR1yoEIbxoHcQ8gmP9iHUeap_uy_wv/view?usp=sharing"
                  target="_blank"
                  rel="noopener noreferrer"
                  download
